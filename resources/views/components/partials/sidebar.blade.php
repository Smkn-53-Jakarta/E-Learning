        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                    ...
                    <div class="menu-item">
                        <div data-kt-menu-trigger="click"
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                @can('statuses.read')
                                    <div class="menu-item">
                                        <a class="menu-link {{ Request::is('admin/status*') ? 'active' : '' }}"
                                ...
                                @can('teachers.read')
                                    <div class="menu-item">
                                        <a class="menu-link {{ Request::is('admin/guru*') ? 'active' : '' }}"
                                ...
                                @can('students.read')
                                    <div class="menu-item">
                                        <a class="menu-link {{ Request::is('admin/murid*') ? 'active' : '' }}"
                                ...
                                @can('courses.read')
                                    <div class="menu-item">
                                        <a class="menu-link {{ Request::is('admin/mata-pelajaran*') ? 'active' : '' }}"
                                ...
                                @endcan
                                @can('school-years.read')
                                    <div class="menu-item">
                                        <a class="menu-link {{ Request::is('admin/tahun-pelajaran*') ? 'active' : '' }}"
                                ...
                                @can('extracurriculars.read')
                                    <div class="menu-item">
                                        <a class="menu-link {{ Request::is('admin/ekstrakurikuler*') ? 'active' : '' }}"
                ...
                @can('schedule-of-subjects.read')
                    <div class="menu-item">
                        <a class="menu-link  {{ Request::is('admin/jadwal-mata-pelajaran*') ? 'active' : '' }}"
                            href="{{ route('schedule-of-subjects.index') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                ...
                @canany(['teacher-raports.read'])
                    <div class="menu-item">
                        <a class="menu-link {{ Request::is('guru/penilaian*') ? 'active' : '' }}"
                ...
                {{-- SIDE BAR MURID --}}
                @can('student-dashboard.index')
                    <div class="menu-item">
                        <a class="menu-link {{ Request::is('murid/dashboard*') ? 'active' : '' }}"
                ...
                @endcan
                {{-- JADWAL MAPEL MURID --}}
                @can('student-schedule-of-subjects.read')
                    <div class="menu-item">
                        <a class="menu-link  {{ Request::is('murid/jadwal-mata-pelajaran*') ? 'active' : '' }}"
                            href="{{ route('student-schedule-of-subjects.index') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                ...
                @canany(['student-raports.read'])
                    <div class="menu-item">
                        <a class="menu-link {{ Request::is('murid/e-raport*') ? 'active' : '' }}"
                            href="{{ route('student-raports.index') }}">
                            <span class="menu-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    fill="currentColor" class="bi bi-filetype-pdf" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd"
                ...
                {{-- SIDEBAR COACH --}}
                @can('coach-dashboard.index')
                    <div class="menu-item">
                        <a class="menu-link {{ Request::is('pelatih/dashboard*') ? 'active' : '' }}"
                            href="{{ route('coach-dashboard.index') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                ...
                @canany(['coach-extracurricular-schedules.read'])
                    <div class="menu-item">
                        <a class="menu-link {{ Request::is('pelatih/ekstrakulikuler*') ? 'active' : '' }}"
                            href="{{ route('coach-extracurricular-schedules.index') }}">
                            <span class="menu-icon">
                                <i class="bi bi-calendar-date" style="font-size: 19px;"></i>
                            </span>
                            <span class="menu-title">Jadwal Ekstrakurikuler</span>
                ...
                @can('coach-extracurricular-assesment.read')
                    <div class="menu-item">
                        <a class="menu-link {{ Request::is('pelatih/ruang-penilaian/ekstrakurikuler*') ? 'active' : '' }}"
                            href="{{ route('coach-extracurricular-assesment.index') }}">
                            <span class="menu-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    fill="currentColor" class="bi bi-filetype-pdf" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd"
