                ...
                <div class="d-flex align-items-center">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="{{ url()->current() }}" class="text-muted text-hover-primary">Pengumpulan
                                    Tugas</a>
                            </li>
                        </ul>
                    </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    <form class="form card-body"
                        action="{{ route('student-submissions.store', ['scheduleOfSubject' => $scheduleOfSubject->id, 'assignment' => $assignment->id]) }}"
                        method="post">
                        @csrf
                        <div class="d-flex flex-column me-n7 pe-7">
                            <div class="fv-row mb-10">
                                ...
                                <input type="url"
                                    ...
                                    placeholder="Masukan Link Drive" name="link_drive" value="{{ old('link_drive') }}"
                                    required />
