                ...
                <div class="d-flex align-items-center">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="{{ url()->current() }}" class="text-muted text-hover-primary">Ruang
                                    Penilaian</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="card-header py-7">
                        <div class="card-title pt-3 mb-0 gap-4 gap-lg-10 gap-xl-15 nav nav-tabs border-bottom-0">
                            <a href="{{ route('student-assignments.index', $scheduleOfSubject->id) }}"
                                class="fs-4 fw-bold pb-3 text-muted">Data
                                Tugas</a>
                            <a href="{{ route('student-submissions.index', $scheduleOfSubject->id) }}"
                                class="fs-4 fw-bold pb-3 border-bottom border-3 border-primary">Data Nilai Tugas</a>
                        </div>
                    </div>
                    <div class="card-body">
                                        ...
                                        @foreach ($submissions as $submission)
                                            <tr>
                                                ...
                                                <td class="text-center"> <span
                                                        class="badge text-bg-primary text-white">{{ $submission->assignment->meeting }}</span>
                                                </td>
