                ...
                <div class="d-flex align-items-center">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="" class="text-muted text-hover-primary">Ruang Tugas</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card card-flush">
                    <div class="card-header mt-6">
                        ...
                        <div class="card-toolbar">
                            <a href="{{ route('teacher-assignments.trashed', 'archive-tugas') }}"
                                class="btn btn-light-primary me-3">
                                <i class="fa-solid fa-trash-can"></i>
                                Sampah
                            </a>
                            <x-AddButton :url="route('teacher-assignments.create')">Tambah Tugas</x-AddButton>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    <tr>
                                        ...
                                        <td>Tugas 1</td>
                                        <td>Buat soal dan jawaban dengan lengkap</td>
                                        <td>Pertemuan 1</td>
                                        <td>01-06-2024</td>
                                        <td>07-06-2024</td>
                                        <td>
