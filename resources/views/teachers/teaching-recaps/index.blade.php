                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    @foreach ($teachingSchedules as $teachingSchedule)
                                        <tr>
                                            ...
                                            <td class="text-start">{{ $teachingSchedule->course->name }}</td>
                                            <td class="text-start">{{ $teachingSchedule->classroom->name }}</td>
                                            <td class="text-start">
                                                <a href="{{ route('teacher-teaching-recaps.show', $teachingSchedule->id) }}"
                                                    class="btn btn-light-primary btn-sm">Lihat Rekap Ajar</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
