                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" data-control="select2" data-placeholder="Pilih Kelas"
                                        ...
                                        @foreach ($classrooms as $classroom)
                                            <option value="{{ $classroom->id }}" @selected(old('classroom_id', $scheduleOfSubject->classroom_id) == $classroom->id)>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" data-control="select2"
                                        ...
                                        @foreach ($teachers as $teacher)
                                            <option value="{{ $teacher->id }}" @selected(old('teacher_id', $scheduleOfSubject->teacher_id) == $teacher->id)>
                            ...
                            <div class="row mb-10">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" data-control="select2"
                                        ...
                                        @foreach ($courses as $course)
                                            <option value="{{ $course->id }}" @selected(old('course_id', $scheduleOfSubject->course_id) == $course->id)>
                                                {{ $course->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" data-control="select2" data-placeholder="Pilih Hari"
                                        name="day" required>
                                        <option value="Senin" @selected(old('day', $scheduleOfSubject->day) == 'Senin')>Senin</option>
                                        <option value="Selasa" @selected(old('day', $scheduleOfSubject->day) == 'Selasa')>Selasa</option>
                                        <option value="Rabu" @selected(old('day', $scheduleOfSubject->day) == 'Rabu')>Rabu</option>
                                        <option value="Kamis" @selected(old('day', $scheduleOfSubject->day) == 'Kamis')>Kamis</option>
                                        <option value="Jumat" @selected(old('day', $scheduleOfSubject->day) == 'Jumat')>Jumat</option>
                                        <option value="Sabtu" @selected(old('day', $scheduleOfSubject->day) == 'Sabtu')>Sabtu</option>
                                        <option value="Minggu" @selected(old('day', $scheduleOfSubject->day) == 'Minggu')>Minggu</option>
                                    </select>
                            ...
                            <div class="row mb-10">
                                <div class="col-md-6">
                                    ...
                                    <input type="time" id="start_time"
                                        ...
                                        value="{{ old('start_time', $scheduleOfSubject->start_time) }}" required />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="time" id="end_time"
                                        ...
                                        value="{{ old('end_time', $scheduleOfSubject->end_time) }}" required />
