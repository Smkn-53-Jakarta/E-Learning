    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                @endif
                <div class="card">
                    <form class="form card-body" action="{{ route('courses.update', $course->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="d-flex flex-column me-n7 pe-7">
                            <div class="fv-row mb-10">
                                ...
                                <input id="name" class="form-control mb-2 @error('name') is-invalid @enderror"
                                    ...
                                    value="{{ old('name', $course->name) }}" maxlength="64" required />
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <input type="number" class="form-control mb-2 @error('kkm') is-invalid @enderror"
                                    placeholder="Masukan kkm" name="kkm" value="{{ old('kkm', $course->kkm) }}"
                                    required />
