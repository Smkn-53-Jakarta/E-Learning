                ...
                <div class="d-flex align-items-center">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="{{ route('teachers.index') }}" class="text-muted text-hover-primary">Guru</a>
                            </li>
                            <li class="breadcrumb-item">
                                <span class="bullet bg-gray-400 w-5px h-2px"></span>
                            </li>
                        ...
                        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                            <div class="card card-flush">
                                ...
                                <div class="card-body text-center pt-0">
                                    <x-Form.InputImage name="profile_picture" :image="'users/images/' . $teacher->user->profile_picture" />
                                    ...
                                    <div class="d-flex flex-column me-n7 pe-7">
                                        <div class="fv-row mb-10">
                                            ...
                                            <input id="name"
                                                ...
                                                value="{{ old('name', $teacher->user->name) }}" maxlength="64"
                                                required />
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <input type="email" id="email"
                                                ...
                                                value="{{ old('email', $teacher->user->email) }}" maxlength="64"
                                                required />
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <input type="number" id="identification_number"
                                                ...
                                                value="{{ old('identification_number', $teacher->identification_number) }}"
                                                required />
