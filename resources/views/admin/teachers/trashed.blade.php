                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                        data-kt-menu="true">
                                                        @can('teachers.restore')
                                                            <div class="menu-item px-3">
                                                                <form
                                                                    action="{{ route('teachers.restore', $teacher->id) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    <a href="#" class="menu-link px-3"
                                                                        onclick="confirmPopup(this, 'Akan mengembalikan guru ini')">Pulihkan</a>
                                                                </form>
                                                            </div>
                                                        @endcan
                                                        @can('teachers.delete')
                                                            <div class="menu-item px-3">
                                                                <form
                                                                    action="{{ route('teachers.force-delete', $teacher->id) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    <a href="#" class="menu-link px-3"
                                                                        onclick="confirmPopup(this, 'Akan menghapus permanen guru ini')">Hapus
                                                                        Permanen</a>
                                                                </form>
                                                            </div>
                                                        @endcan
