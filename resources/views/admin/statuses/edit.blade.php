    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                @endif
                <div class="card">
                    <form class="form card-body" action="{{ route('statuses.update', $status->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="d-flex flex-column me-n7 pe-7">
                            <div class="fv-row mb-10">
                                <label class="fs-5 fw-bold form-label mb-2">
                                    <span class="required">Nama Status</span>
                                </label>
                                <input id="name" class="form-control mb-2 @error('name') is-invalid @enderror"
                                    placeholder="Masukan nama status" name="name"
                                    value="{{ old('name', $status->name) }}" maxlength="64" required />
