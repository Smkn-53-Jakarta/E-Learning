                ...
                <div class="card card-flush">
                    <div class="card-header mt-6">
                        ...
                        <div class="card-toolbar">
                            @if ($extracurricularsTrashed)
                                <a href="{{ route('extracurriculars.trashed') }}" class="btn btn-light-primary me-3">
                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        @foreach ($extracurriculars as $extracurricular)
                                            <tr>
                                                ...
                                                <td>{{ $extracurricular->created_at->diffForHumans() }}</td>
                                                <td>{{ $extracurricular->updated_at->diffForHumans() }}</td>
                                                <td>
                                                    <a href="#"
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <form
                                                                    ...
                                                                    <a href="#" class="menu-link px-3"
                                                                        onclick="confirmPopup(this, 'Akan menghapus ekstrakurikuler ini')">Hapus</a>
                                                                </form>
                                                            </div>
                                                        @endcan
                                                    </div>
