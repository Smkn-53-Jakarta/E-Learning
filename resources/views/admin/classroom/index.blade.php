                ...
                <div class="d-flex align-items-center">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="{{ route('classroom.index') }}" class="text-muted text-hover-primary">Kelas</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card card-flush">
                    <div class="card-header mt-6">
                        ...
                        <div class="card-toolbar">
                            @if ($classroomTrashed)
                                <a href="{{ route('classroom.trashed') }}" class="btn btn-light-primary me-3">
                                    <i class="fa-solid fa-trash-can"></i>
                                    Sampah
                                </a>
                            @endif
                            @can('classroom.create')
                                <x-AddButton :url="route('classroom.create')">Tambah Kelas</x-AddButton>
                            @endcan
                        </div>
                    </div>
                    {{-- <div class="card-body">
