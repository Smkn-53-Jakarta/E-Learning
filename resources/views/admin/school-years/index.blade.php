        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-xxl">
                    ...
                    <div class="card-header mt-6">
                        <div class="card-title">
                            <div class="d-flex align-items-center position-relative my-1 me-5">
                                <x-SearchInput placeholder="Cari Tahun Pelajaran" />
                            </div>
                        </div>
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                    <thead>
                                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="min-w-250px">Nama Tahun Pelajaran</th>
                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        @foreach ($schoolYears as $schoolYear)
                                            <tr>
                                                ...
                                                <td>{{ $schoolYear->created_at->diffForHumans() }}</td>
                                                <td>{{ $schoolYear->updated_at->diffForHumans() }}</td>
                                                <td>
                                                    <a href="#"
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <form
                                                                    ...
                                                                    <a href="#" class="menu-link px-3"
                                                                        onclick="confirmPopup(this, 'Akan menghapus tahun pelajaran ini')">Hapus</a>
                                                                </form>
                                                            </div>
                                                        @endcan
                                                    </div>
                ...
                <div class="d-flex p-5 justify-content-end">
                    {!! $schoolYears->appends($_GET)->links() !!}
                </div>
            </div>
        </div>
    </div>
