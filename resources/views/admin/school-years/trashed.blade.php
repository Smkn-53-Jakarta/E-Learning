                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        @foreach ($schoolYears as $schoolYear)
                                            <tr>
                                                ...
                                                <td>{{ $schoolYear->deleted_at->diffForHumans() }}</td>
                                                <td>
                                                    <a href="#"
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <form
                                                                    ...
                                                                    <a href="#" class="menu-link px-3"
                                                                        onclick="confirmPopup(this, 'Akan mengembalikan Tahun Pelajaran ini')">Pulihkan</a>
                                                                </form>
                                                            </div>
                                                        @endcan
                                                        @can('schoolYears.delete')
                                                            <div class="menu-item px-3">
                                                                <form
                                                                    ...
                                                                    @csrf
                                                                    <a href="#" class="menu-link px-3"
                                                                        onclick="confirmPopup(this, 'Akan menghapus permanen Tahun Pelajaran ini')">Hapus
                                                                        Permanen</a>
                                                                </form>
                                                            </div>
                                                        @endcan
